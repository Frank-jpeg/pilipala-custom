...
11. In recommendation playback, use DPAD up/down to switch videos and confirm switched videos start from 0 seconds.
...
21. Confirm Back cannot bypass the anti-addiction lock page.
22. Confirm parent PIN unlock resumes playback and daily-limit PIN unlock adds only the temporary extra watch time.
23. Confirm real playback has video and audio.
24. Test account-only flows after login if needed.
